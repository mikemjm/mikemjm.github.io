...
I recently discovered that my DJI drone creates and embeds a subtitle track which stores GPS and other data that was gathered during flight. This data can be useful, but most consumer video editors such as Kdenlive and DaVinci Resolve lack the features to overlay embedded subtitle tracks natively. To extract the subtitles we will need to use FFmpeg.
