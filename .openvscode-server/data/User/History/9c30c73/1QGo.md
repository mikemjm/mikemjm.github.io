...
If you own a DJI drone you may have noticed that the recorded video clips contain an embedded subtitle track which stores GPS and other data that was gathered during your flight. This data can be useful, but most consumer video editors such as kDenlive and DaVinci resolve lack the features to overlay embedded subtitle tracks natively. To extract the subtitles we will need to use FFmpeg.
