...
![featured_image](davinci_timeline.png)

### Extracting Subtitles Using FFmpeg

If you own a DJI drone you may have noticed that the recorded video clips contain an embedded subtitle track which stores GPS and other data that was gathered during your flight. This data can be useful, but most consumer video editors such as kDenlive and DaVinci resolve lack the features to overlay embedded subtitle tracks natively. To extract subtitles we will need to use a program like FFmpeg.


* Step 1: Install FFmpeg
* Step 2: Use FFmpeg to extract the embedded tracks
* Step 3: Import the subtitle track into your preferred editor
...
For kDenlive you need to import it from the "Project" drop down menu.
