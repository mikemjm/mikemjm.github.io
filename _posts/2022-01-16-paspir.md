...
![featured_image](PIR-Alert.webp)

### How to receive alerts from your Raspberry Pi when motion is detected.
...
![wiring_schematic](schematic.png)
...
![pushover_setup](pushover_user_key.png)
